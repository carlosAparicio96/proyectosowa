...
CorreoUsuario(data) {// id del usuario == data
  console.log(data)

  return new Promise((resolve, reject) => {
    this.http.post(
      `${apiUrl}BuscarCorreoUsuario`,
      data
    )
      .subscribe(
        (response: any) => {
...
PasswordUsuario(data) {// id del usuario == data
  console.log(data)

  return new Promise((resolve, reject) => {
    this.http.post(
      `${apiUrl}BuscarPasswordUsuario`,
      data
    )
      .subscribe(
        (response: any) => {
 ...
 ModificarNombredUsuario(data) {// nuevo nombre + id del usuario == data 
  console.log(data)

  return new Promise((resolve, reject) => {
    this.http.post(
      `${apiUrl}ModificarNombreUsuario`,
      data
    )
      .subscribe(
        (response: any) => {
